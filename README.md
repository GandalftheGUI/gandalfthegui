...
💪 **[RepMentor](https://github.com/GandalftheGUI/repmentor_public/blob/main/README.md)** (closed source) –  a personal fitness tracker with an AI coach built in. Log workouts, track body measurements, and get coaching that already knows your history — no copying data between apps. [Join the beta!](https://testflight.apple.com/join/WPbhbz7F)
